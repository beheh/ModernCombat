...
public func ChooserFinished()
{
  ...
  {
   //Strukturen
   AddAssaultTarget(CGLO, 180, 300, 400, 1, "$Flag1$", 0, [[350, 460], [245, 550], [550, 350]]);
   ...
   AddAssaultTarget(CGLO, 2280, 210, 400, 2, "$Flag6$", 3, [[2100, 310], [2000, 310], [1900, 320]]);
   AddAssaultTarget(CMSN, 1840, 130, 300, 2, "$Flag4$", 4, [[1845, 240], [1770, 220]]);
   AddAssaultTarget(CCP1, 1710, 330, 300, 2, "$Flag5$", 5, [[1610, 500], [1820, 450], [1885, 475]]);
  }
