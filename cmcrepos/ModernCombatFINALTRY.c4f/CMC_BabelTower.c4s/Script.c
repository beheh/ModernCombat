...
func CreateDecoration()
{
  ...
  //Scheinwerfer
  CreateObject(FLH2, 460, 320, -1)->SetRotation(65);
  CreateObject(FLH2, 710, 320, -1);
  CreateObject(FLH2, 285, 470, -1)->SetRotation(65);
  CreateObject(FLH2, 885, 470, -1)->SetRotation(-65);
...
public func ChooserFinished()
{
  ...
  {
   //Zielobjekte
   AddAssaultTarget(CMSN, 440, 1610, 25*30, 2, "$Target1$", 0, [[[420, 1490], [750, 1490]], [[440, 1940], [585, 1920], [730, 1940]]]);
   AddAssaultTarget(CCP1, 730, 1610, 25*30, 2, "$Target2$", 1, [[[420, 1490], [750, 1490]], [[440, 1940], [585, 1920], [730, 1940]]]);
   AddAssaultTarget(LBPC, 585, 1250, 25*30, 2, "$Target3$", 2, [[[475, 980], [695, 980]], [[430, 1610], [740, 1610]]]);
   AddAssaultTarget(CCP2, 585, 870,  25*30, 2, "$Target4$", 3, [[[445, 660], [585, 590], [725, 660]], [[280, 1240], [890, 1240]]]);
...
public func OnAssaultTargetDestruction(object pTarget, int iTeam, int iIndex, bool fConnectedDestroyed)
{
  ...
  if (!iIndex || iIndex == 1)
  {
   if(fConnectedDestroyed)
   {
    ...
    //Teamgrenze setzen
    FindObject(GASS)->CreateTeamBorder(AssaultDefenderTeam(),0,1460,2,1);
   }
  }
  ...
  if (iIndex == 2)
  {
   ...
   //Teamgrenze setzen
   FindObject(GASS)->CreateTeamBorder(AssaultDefenderTeam(),0,1120,2,1);
  }
}
