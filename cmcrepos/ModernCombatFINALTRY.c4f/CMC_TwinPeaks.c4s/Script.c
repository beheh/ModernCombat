...
func CreateInterior()
{
  ...
  CreateObject(_HBR, 2403, 1492, -1);
  CreateObject(_HBR, 2474, 1492, -1);
  CreateObject(_HBR, 2645, 1442, -1)->SwitchMode();
  CreateObject(_HBR, 3085, 1442, -1)->SwitchMode();
  CreateObject(_HBR, 3256, 1492, -1);
