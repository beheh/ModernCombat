...
func Initialize()
{
  ...
  //Zielscheiben
  CreateObject(TRG2, 670, 80, -1)->AutoRespawn();

  CreateObject(TRGT, 30, 280, -1)->AutoRespawn();
  CreateObject(TRGT, 75, 280, -1)->AutoRespawn();
  CreateObject(TRGT, 120, 280, -1)->AutoRespawn();

  CreateObject(TRGT, 105, 490, -1)->AutoRespawn();

  CreateObject(TRGT, 385, 245, -1)->AutoRespawn();
  CreateObject(TRGT, 505, 245, -1)->AutoRespawn();
  CreateObject(TRGT, 605, 245, -1)->AutoRespawn();

  CreateObject(TRGT, 780, 130, -1)->AutoRespawn();
  CreateObject(TRGT, 850, 130, -1)->AutoRespawn();
  CreateObject(TRGT, 930, 130, -1)->AutoRespawn();

  CreateObject(TRGT, 770, 275, -1)->AutoRespawn();
  CreateObject(TRGT, 940, 275, -1)->AutoRespawn();

  CreateObject(TRGT, 995, 520, -1)->AutoRespawn();
  CreateObject(TRGT, 990, 560, -1)->AutoRespawn();
  CreateObject(TRGT, 1005, 600, -1)->AutoRespawn();
