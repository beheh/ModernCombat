...
func CreateFurniture()
{
  ...
  tmp->SetClrModulation(RGB(255,255,255));
  tmp = CreateObject(SCR3, 2200, 400, -1);
  tmp->SetClrModulation(RGB(255,255,255));
...
func CreateEquipment()
{
  ...
  var tmp = CreateObject (ABOX, 2030, 210, -1);
  tmp->Set(FRAG);
...
func CreateAssaultObjects()
{
  ...
  //Ziel 1
  aTarget[0] = CreateObject(CGLO,1120,360,-1);
  ...
  //Ziel 3
  aTarget[2] = CreateObject(LBPC,1795,490,-1);
  ...
  //Ziel 4
  aTarget[3] = CreateObject(CCP1,2180,510,-1);
  aTarget[3] -> SetName("$Target4$");

  //Ziel 5
  aTarget[4] = CreateObject(CCP1,2200,320,-1);
  aTarget[4] -> SetName("$Target5$");

  //Ziel 6
  aTarget[5] = CreateObject(CCP1,2350,210,-1);
  aTarget[5] -> SetName("$Target6$");

  //Ziel 7
  aTarget[6] = CreateObject(CCP1,2460,320,-1);
  aTarget[6] -> SetName("$Target7$");

  //Ziel 8
  aTarget[7] = CreateObject(CCP1,2455,500,-1);
...
func ResetAssault()
{
  ...
  if(!FindObject(NOAM))
  {
   ...
   var tmp = CreateObject (ABOX, 105, 450, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 135, 450, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 1090, 430, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 1430, 390, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 1720, 210, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 1835, 490, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 2375, 530, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
  }
}
...
func ChooserFinished()
{
  ...
  if(!FindObject(NOAM))
  {
   ...
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 1090, 260, -1);
   tmp->Set(AMOC);
   tmp->SetGraphics("Normal");
   var tmp = CreateObject (ABOX, 1090, 430, -1);
   tmp->Set(AMOC);
