...
public func GetMCData(int data)
{
  ...
  if(data == MC_Power)		return 30;					//Wie weit das Ziel durch Kolbenschläge geschleudert wird
...
public func FMData1(int data)
{
  ...
  if(data == FM_AmmoLoad)	return 90 + (iAttachment == AT_ExtendedMag)*30;		//Magazingröße
