...
/*
 * Das Zuschauerobjekt prueft nicht selbst, ob es nicht mehr gebraucht wird (wegen Netzwerksynchronitaet), 
...
/* Folgender Scriptausschnitt sollte in dem MenuTarget Objekt rein: */
/*
