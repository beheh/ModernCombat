...
func CreateInterior()
{
  ...
  //Möven
  CreateObject(SE4K, 380, 660, -1)->Set("Seagulls*.ogg",500,100, 25,50);
  CreateObject(SE4K, 1170, 630, -1)->Set("Seagulls*.ogg",500,100, 10,25);
  CreateObject(SE4K, 1740, 705, -1)->Set("Seagulls*.ogg",500,100, 10,25);
