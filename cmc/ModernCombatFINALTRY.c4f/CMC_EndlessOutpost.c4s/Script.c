...
func Initialize()
{
  ...
  SetNextMission("ModernCombat.c4f\\CMC_EndlessOutpost.c4s", "$RepeatButton$", "$RepeatButtonDesc$");
  return 1;
}
...
func CreateDecoration()
{
  ...
  var tree = CreateObject(GRAS,676,652,-1);
  tree->SetR(8);
  tree->SetCon(59);
  ...
  CreateObject(BSH2,697,666,-1)->SetCon(10);
  ...
  CreateObject(BSH2,738,705,-1)->SetCon(59);
  CreateObject(BSH2,731,699,-1)->SetCon(15);
