...
public func IsArtilleryBattery()	{return true;}
public func ControlDigSingle(object pByObj) {ControlDig(pByObj);}
...
func Rotation()
{
  ...
  if(!FindObject2(Find_Action("Push"), Find_ActionTarget(this)) && (!pRemoteControl || !(pRemoteControl->IsControlling())))
  {
    bRotate = 0;
