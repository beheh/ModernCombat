...
/* gespeicherte CTF-Flaggen wiederherstellen/lchen */
...
global func CreateFlag(int iTeam, int iX, int iY, int iColor) // Platziert eine Flagge f・ Team iTeam, Position und Farbe angeben
{
...
{
  //Scoreboard-Spielerr舅ge aktualisieren
  if(GetTeamPlayerCount(GetPlayerTeam(iPlr)) > 1)
