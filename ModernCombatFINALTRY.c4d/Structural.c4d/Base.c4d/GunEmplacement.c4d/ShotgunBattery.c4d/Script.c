...
public func FMData1(int data)
{
  ...
  if(data == FM_ProjectileID)	return SHRP;	//ID des Projektils
...
public func Fire1()
{
  ...
  while(i < GetFMData(FM_AmmoUsage, 1))
  {
    ...
    ammo->Launch(angle+RandomX(-5,5),150+Random(50),400+Random(50),3,50,GetFMData(FM_Damage, 1),0,0,1);
    i++;
  }
  ...
  {
    Sound("PSTL_Empty.ogg", 0, this, 0, GetOwner(user)+1);
