...
public func ChooserFinished()
{
  ...
  if (FindObject(GASS))
  {
   ...
   AddAssaultTarget(MVNT, 2265, 250, 30*30, 2, "$Target3$", 2, [[[1970, 70], [1990, 70], [2230, 110]], [[1510, 260], [1530, 360],[1530, 430]]]);
   AddAssaultTarget(LBPC, 2080, 493, 0, 2, "$Target4$", 3, [[[2150, 210], [2210, 110], [2250, 320]], [[1450, 200], [1400, 180], [1510, 260]]]);
   AddAssaultTarget(CCP2, 2580, 510, 25*30, 2, "$Target5$", 4, [[[2280, 110], [2450, 110]], [[1955, 550], [1870, 522], [1820, 390]]]);
   AddAssaultTarget(LBPC, 2600, 320, 25*30, 2, "$Target4$", 5, [[[2280, 110], [2450, 110]], [[1955, 550], [1870, 522], [1820, 390]]]);
