...
public func ChooserFinished()
{
  ...
  if (FindObject(GASS))
  {
   ...
   //Ziel 1
   AddAssaultTarget(HBSN, 1200, 390, 250, 2, "$Flag1$", 0, [[[1550, 400], [1670, 440], [1370, 440]], [[560, 440], [610, 440], [660, 440]]]);

   //Ziel 2
   AddAssaultTarget(HBSN, 2720, 340, 250, 2, "$Flag2$", 1, [[[2870, 410], [2980, 370], [2970, 510]], [[1670, 440], [1790, 430], [1880, 420]]]);

   //Ziel 3
   AddAssaultTarget(HBSN, 3580, 630, 300, 2, "$Flag3$", 2, [[[3795, 410], [3795, 530], [3690, 330]], [[2690, 410], [2710, 510], [2840, 592]]]);

   //Ziel 4
   AddAssaultTarget(HBSN, 4520, 390, 300, 2, "$Flag4$", 3, [[[4760, 460], [4870, 440], [5000, 390]], [[3570, 330], [3600, 410], [3470, 630]]]);

   //Ziel 5
   AddAssaultTarget(HBSN, 5640, 340, 300, 2, "$Flag5$", 4, [[[6040, 380], [6040, 570], [6180, 380]], [[4290, 410], [4320, 470], [4320, 580]]]);

   //Ziel 6
   AddAssaultTarget(HBSN, 6440, 340, 350, 2, "$Flag6$", 5, [[[6560, 410], [6880, 510], [6520, 640]], [[5630, 400], [5630, 470], [5730, 550]]]);

   //Ziel 7
   AddAssaultTarget(HBSN, 7230, 360, 350, 2, "$Flag7$", 6, [[[7580, 510], [7565, 410], [7750, 320]], [[6410, 340], [6460, 510], [6370, 510]]]);
  }
