...
func CreateEquipment()
{
  ...
  //Blackhawks
  SetupVehicleSpawn([BKHK],DIR_Right,CreateObject(VSPW,1655,270,-1),100*21,300);
  SetupVehicleSpawn([BKHK],DIR_Left,CreateObject(VSPW,4355,270,-1),100*21,300);
...
public func ChooserFinished()
{
  ...
  {
   //Zielobjekte
   AddAssaultTarget(CMSN, 1650, 300, 500, 1, "$Flag1$", 2, [[1500, 500], [1680, 440], [1340, 400]]);
   AddAssaultTarget(CMSN, 4350, 300, 500, 2, "$Flag3$", 0, [[4330, 440], [4490, 500], [4690, 400]]);
  }
